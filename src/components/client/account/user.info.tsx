...
import { App, Avatar, Button, Col, Form, FormProps, Input, Upload, Row } from "antd";
import type { UploadFile } from 'antd'
import { useEffect, useState } from "react";
import { UploadRequestOption as RsCustomRequestOptions } from "rc-upload/lib/interface";
...
const UserInfo = () => {
    ...
    const handleUploadFile = async (options: RsCustomRequestOptions) => {
